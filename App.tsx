  ...
  <svg
    ...
    className={`w-full h-full transition-all duration-300 ${
      active
        ...
        : 'opacity-60 grayscale-[0.8] hover:grayscale-0 hover:opacity-100 hover:scale-105'
    }`}
...
const Attendance3D = ({ active }: { active: boolean }) => (
  ...
  >
    ...
    />
    <path
      d="M12 24 L52 24 L52 18 Q52 14 48 14 L16 14 Q12 14 12 18 Z"
      fill="url(#cal_bg)"
    />
    <circle cx="20" cy="12" r="3" fill="#991b1b" />
    <circle cx="44" cy="12" r="3" fill="#991b1b" />
    <path
      d="M22 38 L30 46 L44 30"
      fill="none"
      stroke="#10b981"
      strokeWidth="5"
      strokeLinecap="round"
...
const More3D = ({ active }: { active: boolean }) => (
  ...
  >
    <defs>
      <linearGradient id="grid_grad" x1="0" y1="0" x2="1" y2="1">
...
// ========== AppContent بدون منطق تسجيل الدخول ==========
