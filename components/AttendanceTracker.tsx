...
const AttendanceTracker: React.FC<AttendanceTrackerProps> = ({ students, classes, setStudents }) => {
  ...
  return (
    <div className="space-y-0 pb-32 md:pb-8 bg-[#f2f2f7] min-h-full">
      ...
      {/* iOS Style Header - REMOVED STICKY behavior */}
      <div className="bg-[#f2f2f7] px-4 pt-2 pb-2 border-b border-gray-300/50">
             ...
             <div className="flex gap-2">
                 ...
                 <div className="relative">
                    <select 
                        ...
                        className="appearance-none bg-white text-blue-600 font-bold text-xs py-2 pl-3 pr-8 rounded-full border-none shadow-sm focus:ring-0 cursor-pointer"
                    >
                 ...
                 <div className="relative">
                    ...
                    />
                    <button className="bg-white text-blue-600 font-bold text-xs py-2 px-3 rounded-full shadow-sm flex items-center gap-1">
                            ...
                            <div className="flex items-center justify-end gap-3 w-full sm:w-auto">
                                <div className="flex gap-2">
                                    <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${status === 'present' ? 'bg-green-500 text-white shadow-lg shadow-green-200 scale-110' : 'bg-green-50 text-green-600 hover:bg-green-100'}`}
                                        title="حاضر"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${status === 'absent' ? 'bg-red-500 text-white shadow-lg shadow-red-200 scale-110' : 'bg-red-50 text-red-600 hover:bg-red-100'}`}
                                        title="غائب"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${status === 'late' ? 'bg-amber-500 text-white shadow-lg shadow-amber-200 scale-110' : 'bg-amber-50 text-amber-600 hover:bg-amber-100'}`}
                                        title="تأخير"
                                    >
                                ...
                                {(status === 'absent' || status === 'late') && (
                                    <button 
                                        ...
                                        className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-500 text-white active:scale-90 transition-transform shadow-lg shadow-blue-200"
                                    >
