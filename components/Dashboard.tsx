...
import { 
  ...
  PlayCircle, AlarmClock, ChevronLeft, User, Check
} from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({
    ...
    // ... (keep getSubjectIcon function as is) ...
    ...
    // ... (keep handleImageUpload, handleStampUpload, handleMinistryLogoUpload as is) ...
    ...
    const getTeacherImage = () => {
        if (teacherInfo.avatar) return teacherInfo.avatar;
    ...
    return (
        <div className="space-y-6 pb-20 text-slate-900 animate-in fade-in duration-500">
            ...
            {/* 1. Header Profile (Reverted to Dropdown Menu) */}
