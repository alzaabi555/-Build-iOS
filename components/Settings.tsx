  ...
  return (
    <div className="flex flex-col h-full bg-[#f8fafc] text-slate-900 animate-in fade-in slide-in-from-bottom-4 duration-500 font-sans">
        ...
        <div className="flex items-center gap-4 pt-4 px-2 mb-2">
            <div className="w-14 h-14 bg-white border border-slate-200 rounded-2xl flex items-center justify-center text-slate-600 shadow-sm">
                <Database size={30} />
            </div>
            <div>
                <h2 className="text-3xl font-black text-slate-800 tracking-tight">إدارة البيانات</h2>
                <p className="text-slate-500 text-xs font-bold mt-1">النسخ الاحتياطي والاستعادة</p>
            </div>
        </div>

        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-200 shadow-xl space-y-8">
